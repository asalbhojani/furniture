...
class tableDescription extends StatefulWidget {
  String img;
  String price;
  String name;

  tableDescription({required this.img,required this.price,required this.name});

  @override
  State<tableDescription> createState() => _tableDescriptionState();
}

class _tableDescriptionState extends State<tableDescription> {
  @override
