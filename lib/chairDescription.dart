...
class chairDescription extends StatefulWidget {
  String img;
  String price;
  String name;

  chairDescription({required this.img,required this.price,required this.name});

  @override
  State<chairDescription> createState() => _chairDescriptionState();
}

class _chairDescriptionState extends State<chairDescription> {
  @override
